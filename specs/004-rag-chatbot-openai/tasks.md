...
- [x] T003 Install all backend dependencies in `backend/requirements.txt` (`fastapi`, `uvicorn`, `openai`, `openai-agents` or `chatkit-sdk`, `qdrant-client`, `psycopg2-binary`, `python-dotenv`, `pydantic`).
- [x] T004 Create `backend/.env.example` file based on the spec's environment variables.
- [x] T005 Initialize basic FastAPI app in `backend/app/main.py` and configure CORS as per `CORS_ORIGINS` environment variable.
...
- [x] T006 Setup Neon Postgres connection:
...
- [x] T008 [US1] Develop Document Embedding Pipeline (`backend/app/services/embeddings_service.py`):
...
- [x] T009 [US1] Integrate OpenAI Agent (`backend/app/services/agent_service.py`):
...
- [x] T010 [US1] Implement RAG Chat Endpoint (`backend/app/api/chat.py`):
...
- [x] T011 [US2] Implement Text Selection Endpoint (`backend/app/api/chat.py`):
...
- [x] T012 [US4] Implement Health & Utility Endpoints (`backend/app/api/monitoring.py`):
...
- [x] T013 Create Frontend Chat Button Component (`physical-ai-book/src/components/ChatButton.tsx`):
...
- [x] T014 Create Frontend Chat Window Component (`physical-ai-book/src/components/ChatWindow.tsx`):
...
- [x] T015 Create Message Display Components (`physical-ai-book/src/components/MessageList.tsx`, `MessageBubble.tsx`):
...
- [x] T016 Create Message Input Component (`physical-ai-book/src/components/MessageInput.tsx`):
...
- [x] T017 Create Agent Thinking Indicator (`physical-ai-book/src/components/AgentThinking.tsx`):
...
- [x] T018 Create API Service Integration (`physical-ai-book/src/services/api.ts`):
...
- [x] T019 Create Text Selection Handler (`physical-ai-book/src/components/TextSelectionHandler.tsx`):
...
- [x] T020 Implement State Management with Context (`physical-ai-book/src/contexts/ChatContext.tsx`):
...
- [x] T021 Integrate Chat in Docusaurus (`physical-ai-book/src/theme/Root.tsx`):
...
- [x] T025 Final Polish & Optimization:
