...
The data model for this feature is based on the file structure and front matter conventions of the Docusaurus framework.

## Entities

### 1. Module
A self-contained learning unit, represented as a top-level directory within the Docusaurus `docs` folder.
- **Example**: `/docs/module-1-ros2-fundamentals`

### 2. Page
A single content page within a Module, represented by a Markdown (`.md` or `.mdx`) file.
- **Example**: `intro.md`, `concepts.md`
...
- **Example**: `/docs/module-1-ros2-fundamentals/_category_.json`
